...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.is_public'
        db.add_column('rna_release', 'short_google_play_note',
                      self.gf('django.db.models.fields.TextField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.is_public'
        db.delete_column('rna_release', 'short_google_play_note')
    ...
    models = {
        'rna.note': {
            ...
            'short_google_play_note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
